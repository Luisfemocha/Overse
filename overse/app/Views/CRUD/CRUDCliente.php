<meta charset="UTF-8">
	...
	<title>CRUD CLIENTE - OVERSE</title>
</head>
<body class="cuerpo">
	<header>
		<div class="contenedor">
			...
			<nav>
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item dropActivo textoPrincipal" href="Cliente">Cliente</a>
    ...
    <main>
		<button type="button" class="btn btn-dark btn-lg btn-block" data-toggle="modal" data-target="#crearC">CREAR CLIENTE</button>
		<div class="modal fade" id="crearC" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				...
				<div class="modal-body">
					<form action="<?php echo base_url('public/CRUDCliCont/registrar') ?>" method="post">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
						<td class="textoPrincipal"><?php echo($valor->idC) ?></td>
						<td class="textoPrincipal"><?php echo($valor->nomC) ?></td>
						<td class="textoPrincipal"><?php echo($valor->telC) ?></td>
						<td class="textoPrincipal"><?php echo($valor->corC) ?></td>
						<td class="textoPrincipal">
							<a href="<?php echo base_url('public/CRUDCliCont/eliminar'.$valor->idC) ?>" class="btn btn-danger">Eliminar</a>
						</td>
				</tr>
				<?php endforeach?>
			</tbody>
